import { AdvertisingStrategies, ArtistManagement, Branding, ContentIdeas, GoogleAds, GoogleAnalytics, InstagramAds, Keyword, LeadGeneration, SEO, YoutubeAds } from "@/assets"

export const serviceData = {
    header: "We Offer a Wide Range of Brand Services",
    details: "At PromoDaddy Digital, we're passionate about helping businesses thrive in the digital age. We offer a comprehensive suite of services designed to elevate your online presence and achieve your marketing goals",
...
export const ourClient = [
    ...
    {
        header: "Instagram Advertising and Facebook Ads (1M impression in 10000 rupees)",
        text: "Runs targeted ads on Instagram and Facebook to connect with specific demographics",
        img: InstagramAds.src
    },
    {
        header: "Keyword Research (charges depend on keyword volume min charges 500 inr)",
